...
class t_timer
{
    ...
    timeval tval1, tval2;
    public:
    t_timer() : cpu_time(0), real_time(0) {} ;
    void start()
    {
	...
	getrusage(RUSAGE_SELF,&usage2); 
        cpu_time += (double)(usage2.ru_utime.tv_sec-usage1.ru_utime.tv_sec);
        cpu_time += (double)(usage2.ru_utime.tv_usec-usage1.ru_utime.tv_usec)*1e-6;
